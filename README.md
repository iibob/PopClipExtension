...
|替换原文方式|说明|修饰键|
|:---:|---|---|
|默认|使用译文替换原文|`Command (⌘)` 临时启用 **蛇形** 选项；<br/>`Option (⌥)`&nbsp;&nbsp;&nbsp;临时启用 **驼峰** 选项。|
|蛇形|使用蛇形命名风格的译文替换原文|`Command (⌘)` 临时启用 **默认** 选项；<br/>`Option (⌥)`&nbsp;&nbsp;&nbsp;临时启用 **驼峰** 选项。|
|驼峰|使用驼峰命名风格的译文替换原文|`Command (⌘)` 临时启用 **默认** 选项；<br/>`Option (⌥)`&nbsp;&nbsp;&nbsp;临时启用 **蛇形** 选项。|
<br/>
